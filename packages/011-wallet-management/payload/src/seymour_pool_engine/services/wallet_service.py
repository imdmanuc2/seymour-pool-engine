...
class WalletService:
    ...
    def set_worker_payout(self, *, worker_id: UUID, coin: str, network: str, address: str, changed_by: str) -> dict[str, Any]:
    ...
    def worker_payouts(self, worker_id: UUID) -> list[dict[str, Any]]:
        return [self._serialize_worker_payout(row) for row in self.repository.worker_payouts(worker_id)]
