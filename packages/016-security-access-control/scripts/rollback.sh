...
heading "Rollback Package 016"; require_repo
[[ -f "$BACKUP_MARKER" ]] || fail "No Package 016 backup marker found"
BACKUP_DIR="$(cat "$BACKUP_MARKER")"; [[ -d "$BACKUP_DIR" ]] || fail "Backup directory missing"
