...
heading "Rollback Package 003 files"
...
printf '\nDatabase migration 004 is intentionally retained to avoid destructive data loss.\n'
printf 'Package 003 file rollback completed.\n'
